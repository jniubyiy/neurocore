...
use crate::compute_manager::operators_v2::memory_v2::buffer::handle::MatrixBufferHandle;
    ...
    pub fn to_handle(&self) -> MatrixBufferHandle {
        ...
        let handle = mem
            .acquire_matrix_handle(
                self.num_rows,
                self.cols(),
                crate::compute_manager::operators_v2::memory_v2::types::MemoryDeviceKind::HostRam,
                crate::compute_manager::operators_v2::memory_v2::policy::BufferPriority::Medium,
            )
