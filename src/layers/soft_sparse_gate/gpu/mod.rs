...
impl GpuCompute {
    /// Прямой проход SoftSparseGate на GPU (column-major).
    ///
    ...
    /// Обратный проход SoftSparseGate на GPU (column-major).
    ///
